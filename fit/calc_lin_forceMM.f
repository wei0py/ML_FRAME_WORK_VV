     ...
     &   ifeat_tmp
       ...
       integer,allocatable,dimension(:) :: nfeat1,nfeat2,num_ref,
     &    nfeat2i
...
!    Perhaps we should check it later. Here we proceed without checking
        ...
        itype2=iatom_type(list_neigh(jneigh_tmp(jj),iat_tmp(jj))) ! itype2: the type o    f the neighbor
