...
#TODO:
        ...
        #         '''
        #         pass
                #raise ValueError("There are some atoms whose configration can't be described!")
        # print('before calcenergy\n')
