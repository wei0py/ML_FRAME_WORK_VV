...
class MdRunner():
    ...
    def __init__( \
        ...
        data_scaler = DataScalers(f_ds=pm.f_data_scaler, f_feat=pm.f_train_feat, load=True)


        self.atoms=MdImage.fromDir(imageFileDir,nn,data_scaler,isCheckVar,isReDistribute,imageIndex,isProfile)
