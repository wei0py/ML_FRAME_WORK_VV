...
701    continue
       ...
       write(6,*)  
     &  "num of case are different in different trainData.txt.Ftype"
...
!TODO: with PCA:*****************************************
        ...
        S=0.d0
        call dgemm('N','T',nfeat1,nfeat1,num_case(itype),1.d0,
     &  feat_case(1,1,itype),
...
c       write(6,*) "input iseed (negative)"
c       read(5,*) iseed
...
4300   continue
       ...
       do i=1,ntype
          write(11,"(3(i6,2x))") 
     &    iatom_type(i),nfeat1_store(i),nfeat2_store(i)
       end do
       do ii=1,ntype
