...
!        write(6,*) "test2"
        ...
        nfeat2=0.d0
        do k=1,nfeat
        if(abs(EW(nfeat-k+1)).gt.1.E-2) then
        nfeat2=nfeat2+1
        endif
        enddo

        write(6,*) "nfeat, and nfeat2(PCA)", nfeat,nfeat2
...
! The nfeat2 feature is replaced by 1. 
       ...
       open(10,file="feat_new_stored0.CPA."//char(itype+48),
     &     form="unformatted")
       rewind(10) 
...
!  The deature is then shifted and normalized, 
       ...
       open(10,file="feat_new_stored.CPA."//char(itype+48),
     &    form="unformatted")
       rewind(10) 
       write(10) num_case(itype),nfeat2
       do ii=1,num_case(itype)
...
1000    continue
       ...
       open(10,file="weight_feat.PCA."//char(itype+48))
       rewind(10) 
