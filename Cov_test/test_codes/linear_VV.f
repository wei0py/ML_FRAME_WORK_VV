       ...
       real*8,allocatable,dimension(:,:,:) :: feat_ext2,feat_ext1,
     &      feat_ext3
       real*8,allocatable,dimension(:,:,:) :: feat_ext2T,feat_ext1T,
     &      feat_ext3T
...
cccc roughly, 1/3 of the total data
       iselect=0
       do jj=1,5
...
ccccccccccccccccccccccccccccccccc
       ...
       do i=1,ntest
       feat_ext1T(i,j,id)=
     &   exp(-((feat_test(j,i)-xp1(1,id))/xp1(2,id))**2)
       enddo
       enddo
       enddo
...
ccccccccccccccccccccccccccccccccc
       ...
       j3=idd(3,kkk)
       do i=1,ncase
       feat_new(iii+nfeat,i)=feat_ext3(i,j1,1)*feat_ext3(i,j2,1)*
     &   feat_ext3(i,j3,1)
       enddo
       endif
       ...
       call dgemm('N','T',num_ref,num_ref,num_case,1.d0,
     & feat_new,
     & num_ref,feat_new,num_ref,0.d0,S,num_ref)
...
ccccccccccccccccccccccccccccccccc
       ...
       j3=idd(3,kkk)
       do i=1,ntest
       feat_new(iii+nfeat,i)=feat_ext3T(i,j1,1)*feat_ext3T(i,j2,1)*
     &   feat_ext3T(i,j3,1)
       enddo
       endif
